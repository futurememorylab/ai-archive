"""H4: pin the Admin → Prompts tab against N+1 query regressions.
...
def _count_render(monkeypatch, tmp_path, n: int) -> int:
    """Boot a fresh app, seed N prompts, render /admin/prompts, return the SQL
    statement count for that render."""
