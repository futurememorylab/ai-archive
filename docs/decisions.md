...
| 0105 | 2026-06-19 | [Staging SQLite is persisted via its OWN Litestream replica path (gs://catdv-annotator-db/staging, distinct from prod's .../litestream) + mandatory --no-cpu-throttling so it flushes under scale-to-zero; relaxes the ephemeral-staging-DB aspect of 0066/0077](./adr/0105-staging-db-persisted-litestream.md) — *relaxes 0066/0077* |
