...
| 0057 | 2026-06-07 | [Run telemetry — local-first with deferred cloud pipeline](./adr/0057-run-telemetry-local-first.md) |
| 0058 | 2026-06-07 | [Actual run cost on the UI — total-spend semantics + shared usd filter](./adr/0058-actual-run-cost-ui-surfaces.md) |
